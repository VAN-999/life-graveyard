...
import tombstoneCross from '../assets/tombstone-cross.png'
import tombstoneAncient from '../assets/tombstone-ancient.png'
...
const tombstoneMap = {
  ...
  neon: tombstoneNeon,
  cross: tombstoneCross,
  ancient: tombstoneAncient
}
